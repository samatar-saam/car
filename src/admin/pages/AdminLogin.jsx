          ...
          <div className="hidden lg:flex relative bg-gradient-to-br from-purple-700 via-purple-800 to-purple-900 p-10 text-white flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-16">
                ...
                <p className="mt-5 text-purple-200 text-base leading-7 max-w-lg">
                  Manage users, monitor rentals, and oversee system operations.
            ...
            <div className="relative z-10 grid grid-cols-2 gap-4 mt-12">
              <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
                ...
                <p className="text-2xl font-bold">Full Control</p>
                <p className="text-sm text-purple-200">System oversight</p>
              </div>
              <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
                <Users className="w-5 h-5 mb-2 text-purple-200" />
                <p className="text-2xl font-bold">User Mgmt</p>
                <p className="text-sm text-purple-200">Manage accounts</p>
              </div>
              <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
                <Activity className="w-5 h-5 mb-2 text-purple-200" />
                <p className="text-2xl font-bold">Real-time</p>
                <p className="text-sm text-purple-200">Analytics & logs</p>
              </div>
              <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
                <Settings className="w-5 h-5 mb-2 text-purple-200" />
                <p className="text-2xl font-bold">Config</p>
                <p className="text-sm text-purple-200">System settings</p>
              </div>
            </div>
            ...
            <div className="relative z-10 mt-12 bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-white/20">
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                  <p className="font-semibold text-sm">IT Security Team</p>
                  <p className="text-xs text-purple-200">Multi‑factor enabled</p>
                </div>
              </div>
            </div>
          </div>
